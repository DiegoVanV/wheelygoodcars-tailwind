...
Route::middleware('auth')->group(function () {
    ...
    Route::delete('/cars/delete/{car}', [CarController::class, 'deleteCar'])->name('cars.delete');
    Route::post('/cars/search', [CarController::class, 'searchCar'])->name('cars.search'); // Zoeken op kenteken
    Route::get('/cars/showDetails/{id}', [CarController::class, 'showDetailPage'])->name('cars.show');


});

Route::get('/cars/AllCars/', [CarController::class, 'viewAllCars'])->name('cars.viewAllCars'); // pagina om alle auto's te zien
Route::get('/cars/show/{car}', [CarController::class, 'show'])->name('cars.show'); // Pagina met auto-info
